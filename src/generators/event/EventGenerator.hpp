...
using EventGenerator = std::variant<TickEventGenerator, BeatEventGenerator, ArousalEventGenerator, ValenceEventGenerator, TextEventGenerator, ImageEventGenerator>;
